...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo me-auto"><img src="assetss/img/logo.png" alt="" class="img-fluid"></a>-->
      ...
      <a href="dashboard/login" class="appointment-btn scrollto"><span class="d-none d-md-inline">Login</span>/Register</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      ...
      <a href="dashboard/login" class="btn-get-started scrollto">Get Started</a>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <?php 
          $doctoooors = $getFromU->listDoctor();
          foreach($doctoooors as $doctor):
        ?>
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic">
                <img src="dashboard/profileImage/<?=$doctor->profile_pic?>" class="img-fluid" alt="<?=$doctor->firstname?>">
              </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assetss/img/gallery/gallery-7.jpg" class="galelry-lightbox">
                <img src="assetss/img/gallery/gallery-7.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
  ...
  <script src="assetss/vendor/purecounter/purecounter.js"></script>
